...
define([
	'jquery',
	'underscore',
	'text!templates/schedules/add/add-schedule.tpl',
	...
	return BaseView.extend({
		...
		getTitle: function() {
			...
			if (project) {
				...
				//} else {
					return 'Add New ' + '<span class="name">' + project.get('full_name') + '</span>' + ' Schedule';
				//}
			} else {
				return 'Add New Schedule';
			}
		...
		onClickCancel: function() {
			...
			//
			application.navigate('#run-requests/schedules' + (queryString? '?' + queryString : ''));
		}
	});
});
