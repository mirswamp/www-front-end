...
define([
	'jquery',
	'underscore',
	'text!templates/users/accounts/forms/change-password/change-password-form.tpl',
	...
	return FormView.extend({
		...
		getValue: function(kind) {
			switch (kind) {
				case 'current_password':
					return this.$el.find(".current-password input").val();
				case 'new_password':
		...
		getValues: function() {
			return {
				current_password: this.getValue('current_password'),
