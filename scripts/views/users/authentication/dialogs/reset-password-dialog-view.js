...
|******************************************************************************|
|                                                                              |
|        This defines a dialog box that is used to reset a password.           |
|                                                                              |
...
define([
	...
	'underscore',
	'bootstrap/popover',
	'text!templates/users/authentication/dialogs/reset-password-dialog.tpl',
	'utilities/security/password-policy',
	'models/users/password-reset',
	'views/dialogs/dialog-view',
], function($, _, Popover, Template, PasswordPolicy, PasswordReset, DialogView) {
		...
		resetPassword: function(data) {
			...
			new PasswordReset().save(data, {
				...
				success: function() {
					...
					//
					if (application.session.user && application.session.user.isAdmin() && application.session.user != self.options.user) {
						application.notify({
