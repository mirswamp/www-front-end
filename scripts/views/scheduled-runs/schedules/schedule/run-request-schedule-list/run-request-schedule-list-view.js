...
define([
	'jquery',
	'underscore',
	'text!templates/scheduled-runs/schedules/schedule/run-request-schedule-list/run-request-schedule-list.tpl',
	'views/base-view',
	'views/collections/tables/table-list-view',
	'views/scheduled-runs/schedules/schedule/run-request-schedule-list/run-request-schedule-list-item-view'
