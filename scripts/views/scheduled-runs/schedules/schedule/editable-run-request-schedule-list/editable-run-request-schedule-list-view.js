...
define([
	'jquery',
	'underscore',
	'text!templates/scheduled-runs/schedules/schedule/editable-run-request-schedule-list/editable-run-request-schedule-list.tpl',
	'views/scheduled-runs/schedules/schedule/run-request-schedule-list/run-request-schedule-list-view',
	'views/scheduled-runs/schedules/schedule/editable-run-request-schedule-list/editable-run-request-schedule-list-item-view'
