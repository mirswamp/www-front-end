	...
	<div class="form-group">
		...
		<div class="controls">
			<div class="input-group">
				<input type="text" class="required form-control" name="name" id="name" maxlength="100" value="<%- model.get('name') %>">
				<div class="input-group-addon">
					<i class="active fa fa-question-circle" data-toggle="popover" data-placement="top" data-container="body" title="Name" data-content="The name of your software tool, excluding the version." value="<%- model.get('name') %>"></i>
				</div>
			</div>
		</div>
	</div>
