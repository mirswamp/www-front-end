<div class="welcome container">
	<div class="header content row">
		...
		<div class="col-md-5 description content">
			...
			<div class="bottom buttons">
				...
				<button id="register" class="btn btn-lg"><i class="fa fa-pencil"></i>Sign Up!</button>
				<% if (config['github_authentication_enabled']) { %>
				<button id="github" class="btn btn-lg"><i class="fa fa-github"></i>Sign Up with GitHub!</button>
				<% } %>
			</div>
		</div>
	</div>
