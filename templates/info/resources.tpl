<h1><div class="icon"><i class="fa fa-book"></i></div>Resources</h1>
...
<ul>
	<li><a href="https://www.swampinabox.org/doc/SWAMP-VISION-12.22.17.pdf" target="_blank">SWAMP Vision Document</a></li>
	<li><a href="https://www.swampinabox.org/doc/SWAMP-WP005-DevProcess.pdf" target="_blank">From Continuous Integration to Continuous Assurance</a></li>
	<li><a href="http://onlinelibrary.wiley.com/doi/10.1002/spe.2401/abstract" target="_blank">Bad and Good News About Using Software Assurance Tools</a></li>
	<li><a href="https://www.swampinabox.org/doc/SWAMP-WP003-Heartbleed.pdf" target="_blank">Why Do Software Assurance Tools Have Problems Finding Bugs Like Heartbleed?</a></li>
</ul>

<h2><i class="fa fa-heart"></i>Heartbit</h2>
<p><a href="#resources/heartbit">A dissection and simplification of the OpenSSL code responsible for the Heartbleed bug.</a></p>