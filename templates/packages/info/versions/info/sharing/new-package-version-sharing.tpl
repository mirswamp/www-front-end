...
<label class="radio">
	...
	Public
	<p class="description">This package version is public and may be seen by any user.</p>
</label>
<label class="radio">
...
<div class="bottom buttons">
	...
	<button id="cancel" class="btn btn-lg"><i class="fa fa-arrow-left"></i>Cancel</button>
</div>
