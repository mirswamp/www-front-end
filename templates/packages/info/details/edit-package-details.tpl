<h1><div class="icon"><i class="fa fa-pencil"></i></div>Edit Package <span class="name"><%- name %></span></h1>
...
<div class="bottom buttons">
	<button id="save" class="btn btn-primary btn-lg" disabled><i class="fa fa-save"></i>Save Package</button>
