	...
	<div class="panel">
		...
		<div id="filters-info" class="nested panel-collapse collapse in">
			<div class="filters panel-group">
				<div id="category-filter" class="accordion-body <% if (typeof expanded !== 'undefined' && expanded['category-filter']) { %>in <% } %>collapse" />
				<div id="method-filter" class="accordion-body <% if (typeof expanded !== 'undefined' && expanded['method-filter']) { %>in <% } %>collapse" />
			</div>
		</div>
	</div>
</div>
