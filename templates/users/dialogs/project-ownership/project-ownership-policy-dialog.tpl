<div class="modal-header">
	...
	<h1>Project Ownership Use Policy</h1>
</div>
...
<div class="modal-footer">
	<button id="accept-project-ownership-policy" class="btn btn-primary"><i class="fa fa-plus"></i>Accept</button>
	<button id="cancel-project-ownership-policy" class="btn" data-dismiss="modal"><i class="fa fa-times"></i>Cancel</button>
</div>