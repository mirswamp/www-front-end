<h1>Link Existing SWAMP Account to Linked Account</h1>

<p>Please supply your SWAMP username and password to link your SWAMP account to the following linked account: <b><%- username %></b></p>
